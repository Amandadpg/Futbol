...
public class Equipo {
	...
	public void mostrarAlineacion() throws Exception {
		String[] posiciones = { "Portero", "Lateral izquierdo", "Central 1", "Central 2", "Lateral derecho", "Pivote 1",
				"Pivote 2", "Mediapunta", "Extremo izquierdo", "Extremo derecho", "Delantero centro" };
		...
		System.out.println("\nALINEACIÓN:");
		for (int i = 0; i < 11; i++) {
			System.out.println(i + ": " + posiciones[i] + " - " + alineacion[i].getNombre() + " ("
					+ alineacion[i].getDorsal() + ")");
		}
	}
